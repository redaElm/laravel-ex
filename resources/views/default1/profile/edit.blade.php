                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <!-- Tab panes -->
                            <div class="card-body">
                                <form class="form-horizontal form-material" style="direction: rtl;" method="post" role="form" action="{{ route('default1.update', Auth::user()->id) }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="{{ Auth::user()->namegame }}" name="namegame" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">كلمة المرور في لعبة حرب القبائل</label>
                                        <div class="col-md-12">
                                            <input type="Password"  placeholder="{{ Auth::user()->passgame }}" name="passgame" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
